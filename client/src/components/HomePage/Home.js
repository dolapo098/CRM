              ...
              <li className='nav-item'>
                <a href='/' className='nav-link align-middle px-0  t'>
                  <span className='ms-1 d-none d-sm-inline text-dark '>
                    <i class='fa fa-home marginRight' aria-hidden='true'></i>
                    Home
                  </span>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <span className='ms-1 d-none d-sm- text-dark'>
                    <i class='fas fa-bars marginRight'></i>Requests
                  </span>{" "}
                </a>
                <ul
                ...
                >
                  <li className='w-100'>
                    <a href='/' className='nav-link px-0'>
                      ...
                      <span className='d-none d-sm-inline text-dark'>
                        <i class='fa fa-cog marginRight' aria-hidden='true'></i>
                        Settings
                      </span>{" "}
                      1{" "}
                    </a>
                  ...
                  <li>
                    <a href='/' className='nav-link px-0'>
                      ...
                      <span className='d-none d-sm-inline text-dark'>
                        <i
                          class='fa fa-sign-out marginRight'
                          aria-hidden='true'
                        ></i>
                        Sign Out
                      </span>{" "}
